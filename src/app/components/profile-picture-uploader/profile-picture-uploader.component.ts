...
import {BucketNames} from 'src/util/enums/bucket-names.enum';
...
@Component({
  ...
  templateUrl: './profile-picture-uploader.component.pug',
})
export class ProfilePicUploaderComponent implements OnInit, OnDestroy {
  @ViewChild('fileInput')
